...
function Game() {
	...
	this.init = function() {
		...
		//next enemy information
		this.enemyXIndex = 0;
		this.enemyYIndex = 0;
		this.nextEnemyX = 100;
		this.nextEnemyY = 250;
		this.nextEnemySpacer = -imageRepository.enemy.height * 1.5;
	...
	this.launchEnnemy = function() {
			this.enemyPool.get(this.nextEnemyX,this.nextEnemyY,2);
			this.nextEnemyX += imageRepository.enemy.width + 25;
